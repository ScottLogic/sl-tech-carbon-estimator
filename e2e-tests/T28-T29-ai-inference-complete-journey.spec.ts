...
test('T28 - Complete AI inference user journey', async ({
  ...
  await endUsersSection.setMonthlyActiveUsers('50000');
...
test('T29 - AI inference reset functionality', async ({
  ...
  await organisationSection.selectNumberOfEmployess('300');
  ...
  await endUsersSection.setMonthlyActiveUsers('10000');
